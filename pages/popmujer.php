...
$popmujer = $buque->ordenar($orden, $popmujer);
?>
<!DOCTYPE html>
<html lang="en">
<head>
                ...
                <div class="row text-start">
                  ...
                  <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3 centrar">
                    <div class="card" style="width: 19rem;">
                      <a href="prodejem.php?id=<?php echo $mujer['sku']; ?>">
                      <img src="<?php echo '/../productosimg/'.$mujer['IMAGEN']; ?>" class="card-img-top" alt="..."width="200px" height="230px"></a>
                      <div class="card-body">
