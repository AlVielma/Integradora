...
$popniño = $buque->ordenar($orden, $popniño);
?>
<!DOCTYPE html>
<html lang="en">
<head>
             ...
             <div class="mt-3 container-fluid titulos-azul">
               <!-- Titulo -->
                <div class="row border border-3 border-secondary align-items-center p-2 mb-4">
                    <div class="col-md-8">
                    <h1 class="text-start text-black ms-5">Pop Niños</h1>
                    </div>
                    <!-- Filtrador -->
