<div class="sidebar" id="sidebar">
  ...
  <a class="nav-link" href="pendientes.php"><i class="fas fa-spinner"></i><span>Ver Apartados</span></a>
  <a class="nav-link" href="Clientes.php"><i class="fas fa-user"></i><span>Clientes Pop</span></a>
