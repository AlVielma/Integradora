...
$detallesCompras = $carritoModelo->obtenerDetallesCompras();
?>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if ($detalleCompra['estado_id'] == 2) : ?>
                                    ...
                                    <a href="confirmar_compra.php?compra_id=<?php echo $detalleCompra['id']; ?>" class="btn btn-success">Confirmar</a>
                                    <!-- Botón para cancelar la compra -->
                                    <a href="cancelar_compra.php?compra_id=<?php echo $detalleCompra['id']; ?>" class="btn btn-danger">Cancelar</a>
                                <?php else : ?>
                                    <!-- Mostrar mensaje indicando que la compra está confirmada o finalizada -->
                                    <?php echo ($detalleCompra['estado_id'] == 2) ? 'Confirmada' : 'Finalizada'; ?>
                                <?php endif; ?>
                            </td>
                        </tr>
                    <?php endforeach; ?>
